...
#ricohto3cameraconverter = RicohthetaTo3CameraConverter()
#for idx in range(777):
#    filename = "/home/dg/Downloads/220628_COEX_Indoor_workshop/rosbag/_2022-06-28-17-03-29_pathA1_back/omni_image/{:06d}.jpg".format(idx)
#    img = cv2.imread(filename)
#    left, center, right = ricohto3cameraconverter.convert_ricohtheta_to_3camera(img)
#    cv2.imwrite("/home/dg/Downloads/220628_COEX_Indoor_workshop/rosbag/_2022-06-28-17-03-29_pathA1_back/3camera_image/left_{:06d}.jpg".format(idx), left)
#    cv2.imwrite("/home/dg/Downloads/220628_COEX_Indoor_workshop/rosbag/_2022-06-28-17-03-29_pathA1_back/3camera_image/center_{:06d}.jpg".format(idx), center)
#    cv2.imwrite("/home/dg/Downloads/220628_COEX_Indoor_workshop/rosbag/_2022-06-28-17-03-29_pathA1_back/3camera_image/right_{:06d}.jpg".format(idx), right)
