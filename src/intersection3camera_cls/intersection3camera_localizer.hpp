#ifndef __INTERSECTION3CAMERA_LOCALIZER__
#define __INTERSECTION3CAMERA_LOCALIZER__

#include "dg_core.hpp"
#include "intersection3camera_cls/intersection3camera_cls.hpp"
...
namespace dg
{
    ...
    */
    class Intersection3CameraLocalizer: public Intersection3CameraClassifier
    {
    ...
    public:
        ...
        bool initialize(SharedInterface* shared, std::string py_module_path = "./../src/intersection3camera_cls")
        {
            if (!Intersection3CameraClassifier::initialize(py_module_path.c_str(), "intersection3camera_cls", "Intersection3CameraClassifier")) return false;
        ...
        {
            if (!Intersection3CameraClassifier::apply(image, image_time)) return false;
