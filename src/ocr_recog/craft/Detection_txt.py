...
def test_net(net, args, image, text_threshold, link_threshold, low_text, cuda, poly, refine_net=None):
    t0 = time.time()
...
def Config():
    ...
    parser_craft.add_argument('--craft_trained_model', default='weights/craft_mlt_25k.pth', type=str, help='pretrained model')
    ...
    parser_craft.add_argument('--image_path', required=True , type=str,
                              help='image file path')
    args = parser_craft.parse_args()

    # args.trained_model = '/home_hongdo/sungeun.kim/checkpoints/ocr/ocr_trai/craft_mlt_25k.pth'
...
if __name__ == '__main__':
    ...
    print('Loading detection weights from checkpoint ' + args.craft_trained_model)
    ...
    net.load_state_dict(copyStateDict(torch.load(args.craft_trained_model, map_location=device)))
    ...
    image_path = './demo_image/demo_11_all.png'


    Detection_txt(args, image_path,net)