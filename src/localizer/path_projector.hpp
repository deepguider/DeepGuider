...
protected:
    ...
    double m_normal_alignscore_gap = 10;             // Unit: [m], ���� path�� �ű� path�� score ���̰� �� �� �̳��� ������� ������ ���� (���� path�� ��������)
    double m_abnormal_alignscore_gap = 20;          // Unit: [m], ���� path�� �ű� path�� score ���̰� �� ���� �Ѿ�� �����Ż�� ����
...
public:
    ...
    /**
     * ���� ��ġ�� ����� �ݰ� ���� local branch map�� ��ȯ (�� Node ���̿� �ܹ��� edge�� �����ϴ� ���� �������� ����)
     * @param map �� ������
     * @param center_nid �߽� Node ID
     * @param localmap Ž���� local branch map
     * @param search_radius Ž�� �ݰ�
    ...
    static std::vector<Pose2> findProjectedMapPoses(dg::Map* map, const Pose2& p, double search_radius, double error_tolerance = 0.01)
    {
        ...
        for (auto from = map->getHeadNode(); from != map->getTailNode(); from++)
        {
            ...
            // check edge projection: �ش� edge(from)�� gps�� �������� �� �� �ִ��� ����
            Point2 nv = p - *from;
            bool proj_node = true;
            for (auto it = from->edge_ids.begin(); it != from->edge_ids.end(); it++)
            {
